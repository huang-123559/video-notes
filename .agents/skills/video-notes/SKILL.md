...
**Note**: Don't over-screenshot. Typically 5-10 screenshots per 20-minute video is sufficient. Focus on visual-heavy content where text alone isn't enough.
...
- **Screenshot selectively** — only capture frames where visual context adds value (demos, diagrams, UI). Aim for 5-10 screenshots per 20-min video
